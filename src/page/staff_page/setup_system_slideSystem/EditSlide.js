...
const Editimg = ({ ssd_id }) => {
    ...
    const page = () => {
        axios.get("https://flashworkbackend.xyz/Mback/public/getSetup_slide/" + ssd_id)
            .then((response) => {
    ...
    const uploadFileToFirebase = (file) => {
        ...
        const newName = ssd_id+ "_" + timestamp;//เปลี่ยนชื่อ
    ...
    const saveImg = (fileURL) => {
        ...
        if (data.img == "") {
            ...
            axios.put("https://flashworkbackend.xyz/Mback/public/editSetup_slidetimg/" + ssd_id, data)//ส่งค่าไปแอดใน DB
                .then((res) => {
                    ...
                    <Form onSubmit={formik.handleSubmit}>
                        ...
                        <ModalBody>
                            <FormGroup align="left">
                                ...
                                <img src={Mscholar.ssd_slide} alt="" style={{ maxWidth: "470px" }} />
